...
import { registerNeedlescriptConfiguration } from './monaco/configuration.ts';
import { registerNeedlescriptFormattingProvider } from './monaco/formatting.ts';
import {
  registerNeedlescriptDefinitionProvider,
  registerNeedlescriptProviders as registerProviders,
} from './monaco/providers.ts';
import { registerNeedlescriptTokenizer } from './monaco/tokenizer.ts';
import { registerNeedlescriptDarkTheme, registerNeedlescriptLightTheme } from './monaco/themes.ts';
