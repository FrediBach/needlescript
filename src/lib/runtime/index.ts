...
import type { ChalkEvent, RunOptions, RunResult, WarningLocation } from '../core/types.ts';
import type { OverrideKey } from '../core/types.ts';
import { Machine, STOCK_LIMITS } from '../embroidery/machine/index.ts';
...
import { linkStandardModules } from '../language/module-linker.ts';
import { applyAutoTrim, applyLocks, densityMap } from '../embroidery/postprocess.ts';
import { applyTravelPlan } from '../embroidery/travel-planner.ts';
import type { PlanAtomicSpan, PlanRouteGroupSpan } from '../embroidery/travel-planner.ts';
import type { TravelPlanStats } from '../core/types.ts';
import { formatVal, isFuncRef } from './list.ts';
import type { Val } from './list.ts';
import type { ASTNode } from '../core/types.ts';
import { LIMITS } from '../embroidery/machine/index.ts';
