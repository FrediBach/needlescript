...
import { gauss, fork } from '../core/prng.ts';
import { offsetRegion, clipRegions, clipOpenPath, strokePath } from '../geometry/geometry.ts';
...
import { routeItems, ROUTESORT_MODES } from '../embroidery/routing.ts';
import type { RoutePoint } from '../embroidery/routing.ts';
