...
<Checkpoint chapterId="ch-60">
  Import a small SVG containing one shape with both fill and stroke. Confirm that staging shows two
  operations and that the inserted program declares their geometry only once.
</Checkpoint>
