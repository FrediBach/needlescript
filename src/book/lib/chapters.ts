...
export const CHAPTERS: Chapter[] = [
  ...
  {
    id: 'ch-40',
    title: 'Why geometry is not enough',
  ...
  // ── Part IX — Standard Library and Reusable Design ────────────────────
  {
    id: 'ch-54',
  ...
  },
  {
    ...
    subtitle:
      'std.shapes and std.pathops: construction, sampling, dashes, morphs, and open offsets',
    part: 'Part IX — Standard Library and Reusable Design',
    partNumber: 9,
    order: 3,
  ...
  // ── Part X — Tooling and Ecosystem ────────────────────────────────────
  {
    ...
    partNumber: 10,
    order: 1,
    load: () => import('../content/part-10/ch-59.mdx'),
  },
  {
    id: 'ch-60',
    ...
    partNumber: 10,
    order: 2,
    load: () => import('../content/part-10/ch-60.mdx'),
  },
  {
    id: 'ch-61',
    ...
    partNumber: 10,
    order: 3,
    load: () => import('../content/part-10/ch-61.mdx'),
  },
  {
    id: 'ch-62',
    ...
    partNumber: 10,
    order: 4,
    load: () => import('../content/part-10/ch-62.mdx'),
  },
  {
    id: 'ch-63',
    ...
    partNumber: 10,
    order: 5,
    load: () => import('../content/part-10/ch-63.mdx'),
  },
