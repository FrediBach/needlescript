...
export const EXAMPLE_TIERS: { label: string; keys: string[] }[] = [
  {
    label: 'intro',
    keys: ['bloom', 'wreath', 'wander', 'star', 'badge', 'sampler', 'waves', 'shell', 'boustrophedon', 'doublespiral'],
  },
  {
    label: 'intermediate',
    keys: ['tree', 'fern', 'flow', 'patch', 'lorenz', 'meander', 'snowflake', 'orbits', 'waveforms', 'venn', 'spirograph 1', 'spirograph 2', 'disturbance', 'lfowaves', 'wavefront', 'ngon', 'gingham'],
  },
  {
    label: 'advanced',
