...
| `let p = [[0,0],[10,0]] // [path: closed, snap 1]`       | editable polyline/region parameter                                            |
| `let c = [[0,0],[[10,0],[-2,0],[2,0]]] // [curve]`       | editable cubic spec with relative tangent handles                             |
...
| `curvepath(spec, mm)` / `curveflat(spec, tol)`      | construct ordinary paths from editable cubic specs `[[anchor, incomingOffset, outgoingOffset], …]`; both accept a trailing `'closed'` mode                                                                                                                                                                                                                                                                               |
| `pointat` / `headingat` / `normalat` / `paramof`    | normalized arc-length queries, now available without a standard-library import                                                                                                                                                                                                                                                                                                                                           |
